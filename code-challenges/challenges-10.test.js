...
const getNames = (arr) => {
  // Solution code here...
  let array=arr.map(element=> element.name.split('').reverse().join(''));
  return array;
};
...
const count = (target, input) => {
  // Solution code here...
  let arr=input.reduce(function(accumlator,val){
...
const totalSum = (input) => {
  // Solution code here...
  let arr=input.reduce(function(accumlator,val){
    return accumlator+=val.reduce(function(accumlator2,value){return accumlator2=accumlator2+value;
    },0);
  },0);
  return arr;
};
